            ...
            <div class="content-wrapper">
                ...
                <div class="row">
                    <div class="col-12 grid-margin stretch-card">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">编辑联系人</h4>
                                <p class="card-description">
                                    编辑联系人
                                </p>
                                <s:form class="forms-sample" action="lm/update" method="POST" enctype="multipart/form-data" theme="simple">
                                    <s:hidden name="lid" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <s:select list="#{'男':'男','女':'女'}"  headerKey="" headerValue="--请选择--" class="form-control form-control-lg" id="gender" name="gender"  />
                                    </div>
